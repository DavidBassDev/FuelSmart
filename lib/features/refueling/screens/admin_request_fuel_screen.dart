...
import 'package:fuel_smart/features/vehicles/widgets/vehicle_observation_widget.dart';
import 'package:provider/provider.dart';

class AdminRequestFuelScreen extends StatefulWidget {
  const AdminRequestFuelScreen({super.key});

  @override
  State<AdminRequestFuelScreen> createState() => _AdminRequestFuelScreen();
}

class _AdminRequestFuelScreen extends State<AdminRequestFuelScreen> {
